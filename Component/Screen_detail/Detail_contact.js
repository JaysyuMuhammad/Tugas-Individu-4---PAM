...
export default function Screen_detail({ route, navigation }) {
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("Home ContactKu")}
        >
          <AntDesign name="arrowleft" size={26} color="black" />
        </TouchableOpacity>
        <Text style={styles.textHeader}>Detail Kontak</Text>
      </View>
      ...
      <View style={styles.containerInfo}>
        <View style={styles.boxInfo}>
          ...
          <Text style={styles.textInfoBiasa}>{data.nama}</Text>
        </View>

        <View style={styles.boxInfo}>
          <Text style={styles.textInfoBold}>Nomor</Text>
          <Text style={styles.textInfoBiasa}>{data.nomor}</Text>
        </View>

        <View style={styles.boxInfo}>
          <Text style={styles.textInfoBold}>Info</Text>
          <Text style={styles.textInfoBiasa}>{data.info}</Text>
        </View>
      </View>

      <TouchableOpacity
        style={[
          styles.button, { backgroundColor: "green", borderWidth: 0.5 },
        ]}
      >
        <Text style={[styles.textButton, { color: "#FFF" }]}>Ubah</Text>
      </TouchableOpacity>
